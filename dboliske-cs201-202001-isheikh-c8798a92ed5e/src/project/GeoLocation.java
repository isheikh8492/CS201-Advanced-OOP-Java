package project;
//8th May 2020, This class is responsible for calculating and extracting latitude and longitude, and the distances between relative stations.
	public class GeoLocation {
		...
		public boolean latCheck(double lat) { //Exercise 7: This method checks if the 'lat'
			if (lat >= -90 && lat <= 90) { //instance
				return true; //variable value is between -90 & 90
			}
			return false;
		}
		
		public boolean lngCheck(double lng) { //Exercise 8: This method checks if the 'lng'
			if (lng >= -180 && lng <= 180) { //instance variable value is
